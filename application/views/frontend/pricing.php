					...
					<li data-type="monthly" class="is-visible">
						...
						<div class="pricing-body">
							<ul class="pricing-features">
								<li><em><?php echo $package['number_of_listings'].' '.get_phrase('service(s) for'); ?></em> <?php echo get_phrase('this_package'); ?></li>
								<li><em><?php echo $package['number_of_categories'].' '.get_phrase('categories'); ?></em> <?php echo get_phrase('per_service'); ?></li>
								<li><em><?php echo $package['number_of_photos'].' '.get_phrase('photos'); ?></em>  <?php echo get_phrase('per_service'); ?></li>
								<li><em><?php echo $package['number_of_tags'].' '.get_phrase('tags'); ?></em> <?php echo get_phrase('per_service'); ?></li>
								...
								<li><?php echo $package['featured'] == 1 ?'<em>'.get_phrase('featured').' '.get_phrase('service(s)').' '.'</em>'.' '.get_phrase('allowed') : '<em>'.get_phrase('featured').' '.get_phrase('listings').' '.'</em>'.' '.get_phrase('unallowed'); ?>
								<li><em><?php echo $package['validity'].' '.get_phrase('days'); ?></em> <?php echo get_phrase('service'); ?></li>
							</ul>
						</div>
						<!-- /pricing-body -->
