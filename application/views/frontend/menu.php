<nav id="menu" class="main-menu">
    <ul>
        ...
        <li><span><a href="<?php echo base_url();?>home/listings"><?php echo get_phrase('events'); ?></a></span></li>
        <li><span><a href="<?php echo base_url();?>home/listings"><?php echo get_phrase('book_your_events'); ?></a></span></li>
        <li><span><a href="<?php echo base_url();?>home/category"><?php echo get_phrase('category'); ?></a></span></li>
        <li><span><a href="<?php echo base_url();?>home/pricing"><?php echo get_phrase('become_a_vendor'); ?></a></span></li>
